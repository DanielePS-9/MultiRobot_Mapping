# Modified from arshadlab/tb3_multi_robot: https://github.com/arshadlab/tb3_multi_robot/blob/master/multi_robot_scripts/utils.py
...
def create_namespaced_bridge_yaml(base_yaml_path, namespace):
    ...
    for bridge in bridges:
        # Doesn't bridge the clock topic
        ...
        # cast message type from TwistStamped to Twist because it is needed by Gazebo
...
def load_sdf_with_namespace(model_path, namespace):
    ...
    topic_map = {
        ...
        '<topic>camera</topic>': f'<topic>{namespace}/camera</topic>',
        ...
        # Force also frames to be namespaced in order to have a connected TF tree
